...
n_sim <- 5000 # antall iterasjoner i simuleringene

for (m in 1:antall_elver) {

  # test om vassdraget skal inkluderes i simulering, loop til neste vassdrag dersom ikke
  if (elveliste$GytingSim[m]) {
    ...
    til_fil_beskatning_fangstandel <-  d %>% select(Vassdrag, Vdrnr, Aar,
